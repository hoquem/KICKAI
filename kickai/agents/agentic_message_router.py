            ...
            try:
                ...
                if "Command registry not initialized" in str(e):
                    ...
                    try:
                        ...
                        chat_type_str = message.chat_type.value
                        available_command = registry.get_command_for_chat(command_name, chat_type_str)
                        logger.info("✅ Successfully initialized command registry in current context")
                        ...
                        logger.warning(f"⚠️ Allowing command {command_name} to proceed without registry validation")
                else:
                    raise
