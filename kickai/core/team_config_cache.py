...
class TeamConfigCache:
    ...
    async def initialize(self):
        ...
        try:
            ...
            logger.info(f"🎯 Team config cache initialized with {len(self._configs)} configurations")
    ...
    def get_main_chat_id(self, team_id: str) -> Optional[str]:
        """Quick accessor for main chat ID"""
        team = self.get_team(team_id)
        return team.main_chat_id if team else None
    
    def get_leadership_chat_id(self, team_id: str) -> Optional[str]:
