    ...
    async def _validate_agent_factory(self) -> Tuple[CheckStatus, str, List[str]]:
        ...
        try:
            ...
            try:
                ...
                issues.append(f"Factory method validation failed: {e!s}")
            ...
            try:
                ...
                issues.append(f"LLM configuration access failed: {e!s}")

        except Exception as e:
            issues.append(f"Agent factory validation failed: {e!s}")
        ...
        try:
            ...
            for agent_name in critical_agents:
                try:
                    ...
                    creation_failures.append(f"{agent_name}: {e!s}")
            ...
            issues.append(f"Agent creation validation failed: {e!s}")
    ...
    async def _validate_tool_assignment(self) -> Tuple[CheckStatus, str, List[str]]:
        ...
        try:
            ...
            try:
                ...
                issues.append(f"Cannot access tools from registry: {e!s}")
            ...
            for agent_name, expected_tools in test_agent_configs:
                try:
                    ...
                    issues.append(f"Tool assignment check failed for {agent_name}: {e!s}")

        except Exception as e:
            issues.append(f"Tool assignment validation failed: {e!s}")
    ...
    async def _validate_llm_configuration(self) -> Tuple[CheckStatus, str, List[str]]:
        ...
        try:
            ...
            try:
                ...
                issues.append(f"LLM connectivity test error: {e!s}")
            ...
            try:
                ...
                issues.append(f"Model configuration validation failed: {e!s}")

        except Exception as e:
            issues.append(f"LLM configuration validation failed: {e!s}")
    ...
    async def _validate_agent_communication(self) -> Tuple[CheckStatus, str, List[str]]:
        ...
        try:
            ...
            try:
                ...
                issues.append(f"Agent communication test failed: {e!s}")
            ...
            try:
                ...
                issues.append(f"Message router validation failed: {e!s}")

        except Exception as e:
            issues.append(f"Agent communication validation failed: {e!s}")
    ...
    async def _validate_agent_performance(self) -> Tuple[CheckStatus, str, List[str]]:
        ...
        try:
            ...
            try:
                ...
                issues.append(f"Agent creation performance test failed: {e!s}")
            ...
            try:
                ...
                issues.append(f"Memory usage check failed: {e!s}")

        except Exception as e:
            issues.append(f"Agent performance validation failed: {e!s}")
    ...
    async def _validate_error_recovery(self) -> Tuple[CheckStatus, str, List[str]]:
        ...
        try:
            ...
            try:
                ...
                issues.append(f"Tool registry error handling test failed: {e!s}")
            ...
            try:
                ...
                issues.append(f"LLM error recovery test failed: {e!s}")

        except Exception as e:
            issues.append(f"Error recovery validation failed: {e!s}")
