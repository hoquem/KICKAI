...
from kickai.core.enums import CheckCategory, CheckStatus, AgentRole
...
class SystemReadinessCheck(BaseCheck):
    ...
    async def execute(self, context: dict[str, Any]) -> Any:
        ...
        try:
            ...
            try:
                from kickai.core.command_registry_initializer import get_initialized_command_registry, initialize_command_registry
