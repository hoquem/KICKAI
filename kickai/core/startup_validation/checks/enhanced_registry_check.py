...
class EnhancedRegistryCheck(BaseCheck):
    ...
    async def _validate_tool_registry(self) -> tuple[CheckStatus, str, list[str]]:
        ...
        try:
            ...
            try:
                ...
                issues.append(f"Cannot access tool names: {e!s}")
            ...
            try:
                ...
                issues.append(f"Tool category validation failed: {e!s}")

        except Exception as e:
            issues.append(f"Tool registry access failed: {e!s}")
    ...
    async def _validate_agent_registry(self) -> tuple[CheckStatus, str, list[str]]:
        ...
        try:
            ...
            details.append("✅ Agent factory initialized with required methods")

        except Exception as e:
            issues.append(f"Agent registry validation failed: {e!s}")
    ...
    async def _validate_dependency_container(self) -> tuple[CheckStatus, str, list[str]]:
        ...
        try:
            ...
            for service_name in required_services:
                try:
                    if hasattr(container, 'get_service'):
                        ...
                        details.append("✅ Container has get_service method")
                    else:
            ...
            try:
                ...
                issues.append(f"Cannot access container services: {e!s}")

        except Exception as e:
            issues.append(f"Dependency container validation failed: {e!s}")
    ...
    async def _validate_service_factory(self) -> tuple[CheckStatus, str, list[str]]:
        ...
        try:
            ...
            if missing_methods:
                ...
                details.append("✅ ServiceFactory has all required methods")
            ...
            try:
                ...
                issues.append(f"ServiceFactory import issues: {e!s}")

        except Exception as e:
            issues.append(f"Service factory validation failed: {e!s}")
        ...
        try:
            ...
            for module_a, module_b in problematic_imports:
                try:
                    ...
                    circular_found.append(f"{module_a} <-> {module_b}: {e!s}")
            ...
            issues.append(f"Circular dependency detection failed: {e!s}")
    ...
    async def _validate_registry_synchronization(self) -> tuple[CheckStatus, str, list[str]]:
        ...
        try:
            ...
            issues.append(f"Registry synchronization check failed: {e!s}")
