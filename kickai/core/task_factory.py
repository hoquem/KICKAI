...
class TaskFactory:
    ...
    def _initialize_templates(self) -> dict[str, TaskTemplate]:
        ...
        return {
            ...
            TaskType.HELP_REQUEST: TaskTemplate(
                ...
                required_tools=["get_available_commands", "get_command_help", "get_welcome_message"],
    ...
    :return: Configured CrewAI Task with structured output
...
class TaskMonitor:
    ...
    def cleanup_old_tasks(self, max_age_hours: int = 24):
        ...
        to_remove = [
            task_id for task_id, metrics in self.completed_tasks.items()
