...
class MatchAvailabilityOutput(BaseModel):
    ...
    availability: list[PlayerAvailabilityInfo] = Field(
        default_factory=list, description="Player availability"
    )
...
class CommunicationOutput(BaseModel):
    ...
    recipients: list[MessageDeliveryInfo] = Field(
        default_factory=list, description="Delivery information"
    )
