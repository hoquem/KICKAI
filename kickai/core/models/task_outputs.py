...
class PlayerInfo(BaseModel):
    ...
    registration_date: Optional[datetime] = Field(None, description="When player registered")
...
class PlayerStatusOutput(BaseModel):
    ...
    player: Optional[PlayerInfo] = Field(None, description="Player information")
...
class PlayersListOutput(BaseModel):
    ...
    filter_applied: Optional[str] = Field(None, description="Filter applied to the list")
    error_message: Optional[str] = Field(None, description="Error message if failed")
...
class TeamMemberInfo(BaseModel):
    ...
    join_date: Optional[datetime] = Field(None, description="When member joined")
...
class MatchInfo(BaseModel):
    ...
    result: Optional[str] = Field(None, description="Match result if played")
...
class PlayerAvailabilityInfo(BaseModel):
    ...
    response_date: Optional[datetime] = Field(None, description="When player responded")
    notes: Optional[str] = Field(None, description="Additional notes from player")
...
class MessageDeliveryInfo(BaseModel):
    ...
    error: Optional[str] = Field(None, description="Delivery error if any")
...
class CommunicationOutput(BaseModel):
    ...
    broadcast_id: Optional[str] = Field(None, description="Broadcast identifier for tracking")
    error_message: Optional[str] = Field(None, description="Error message if failed")
