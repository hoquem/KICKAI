...
from kickai.core.interfaces import (
    IPlayerService, ITeamService, IUserService, IValidationService,
...
class ServiceFactory:
    ...
    def create_team_service(self, team_id: TeamId) -> ITeamService:
        ...
        # Import and create service
        from kickai.features.team_administration.domain.services.team_service import (
            TeamService
        )
    ...
    def create_validation_service(self) -> IValidationService:
        ...
        # Create new service if not in cache
        from kickai.features.shared.domain.services.validation_service import (
            ValidationService
        )
    ...
    def create_analytics_service(self, team_id: TeamId) -> IAnalyticsService:
        ...
        from kickai.features.analytics.domain.services.analytics_service import (
            AnalyticsService
        )
