...
class ServiceFactory:
    ...
    def create_base_services(self):
        ...
        self.container.register_service(SystemService, system_service)
        self.container.register_service(ISystemService, system_service)
    ...
    def create_team_services(self):
        ...
        # Create TeamMemberManagementService (needed by team administration tools)
        ...
        # Create SimplifiedTeamMemberService
        ...
        # Create TeamMemberManagementService
        management_service = TeamMemberManagementService(
            team_member_repo, simplified_service, team_member_service
        )
