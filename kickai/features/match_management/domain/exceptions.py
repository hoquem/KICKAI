...
class MatchNotFoundError(MatchServiceError):
    ...
    def __init__(self, match_id: str):
        ...
        super().__init__(f"Match not found: {match_id}", context={"match_id": match_id})
...
class InvalidOpponentError(MatchValidationError):
    ...
    def __init__(self, opponent: str):
        ...
        super().__init__(f"Invalid opponent name: {opponent}", context={"opponent": opponent})
...
class InvalidVenueError(MatchValidationError):
    ...
    def __init__(self, venue: str):
        self.venue = venue
        super().__init__(f"Invalid venue: {venue}", context={"venue": venue})
