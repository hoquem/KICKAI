    ...
    async def get_active_players(self, context: PlayerToolContext) -> ActivePlayersResponse:
        ...
        try:
            ...
            if players:
                ...
                logger.info(f"🚨 ANTI-HALLUCINATION: Returning 'no players found' - DO NOT ADD FAKE PLAYERS")
            ...
            if players:
                ...
                for fake_indicator in fake_player_indicators:
                    if fake_indicator in response_text:
                        ...
                        logger.error(f"🚨 THIS SHOULD NEVER HAPPEN - SERVICE IS ONLY RETURNING DATABASE DATA")
