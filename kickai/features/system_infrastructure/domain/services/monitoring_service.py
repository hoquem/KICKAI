...
# IBotStatusService interface removed - no concrete implementation
...
class MonitoringService:
    def __init__(
        self, data_store: DataStoreInterface, bot_status_service=None
    ):  # IBotStatusService interface removed
    ...
    async def perform_system_health_check(self) -> Dict[str, Any]:
        try:
            ...
            try:
                ...
                health_status["checks"]["bot"] = {"status": "unhealthy", "error": str(e)}
