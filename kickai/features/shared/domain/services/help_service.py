...
from kickai.features.shared.domain.models.help_models import CommandInfo, HelpContent

# CommandInfo and HelpContent classes moved to kickai/features/shared/domain/models/help_models.py
...
class HelpService(IHelpService):
    ...
    def _generate_main_chat_help(self, username: str) -> HelpContent:
        ...
        return HelpContent(
            title="🏈 KICKAI Commands - Main Chat",
    ...
    def _generate_leadership_help(self, username: str) -> HelpContent:
        ...
        return HelpContent(
            title="🏈 KICKAI Commands - Leadership Chat",
    ...
    def _generate_private_help(self, username: str) -> HelpContent:
        ...
        return HelpContent(
            title="🏈 KICKAI Commands - Private Chat",
    ...
    def format_help_message(self, help_content: HelpContent) -> str:
        ...
        """
        lines = [help_content.title, "=" * 50, "", help_content.description, ""]
        ...
        lines.extend(["=" * 50, help_content.footer])
