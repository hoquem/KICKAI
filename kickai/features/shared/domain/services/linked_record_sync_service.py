...
class LinkedRecordSyncService:
    ...
    async def sync_player_to_team_member(self, telegram_id: int, updated_fields: Dict[str, any]) -> SyncResult:
        """
        ...
        try:
            ...
            syncable_updates = {
                field: value for field, value in updated_fields.items()
            ...
            if not team_member_service:
                ...
                return SyncResult(
                    success=False, 
                    synced_fields=[], 
                    error_message="TeamMemberService not available"
                )
    ...
    async def sync_team_member_to_player(self, telegram_id: int, updated_fields: Dict[str, any]) -> SyncResult:
        """
        ...
        try:
            ...
            if not player_service:
                ...
                return SyncResult(
                    success=False,
                    synced_fields=[],
                    error_message="PlayerService not available"
                )
    ...
    def create_sync_summary(self, sync_result: SyncResult, source_entity: str, target_entity: str) -> str:
        """
    ...
    async def sync_update_operation(self, 
                                   entity_type: str, 
                                   telegram_id: int, 
                                   updated_fields: Dict[str, any]) -> SyncResult:
        """
