...
def analyze_dual_role_potential(
    user_input: str, chat_type: str = None, user_context: str = None
) -> str:
    """
...
def suggest_dual_registration(
    name: str, phone: str, position: str = None, role: str = None, team_id: str = None
) -> str:
    """
...
def execute_dual_registration(
    name: str, phone: str, position: str, role: str, team_id: str, user_id: str = None
) -> str:
    """
...
def check_role_conflicts(position: str, role: str, availability: str = "medium") -> str:
    """
