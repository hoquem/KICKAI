...
class FirebaseTeamMemberRepository(TeamMemberRepositoryInterface):
    ...
    async def create_team_member(self, team_member: TeamMember) -> TeamMember:
        ...
        try:
            ...
            logger.info(f"Successfully created team member {document_id} in team {team_member.team_id}")
            return team_member
    ...
    async def get_team_member_by_id(self, member_id: str, team_id: str) -> Optional[TeamMember]:
    ...
    async def get_team_member_by_telegram_id(self, telegram_id: int, team_id: str) -> Optional[TeamMember]:
        ...
        try:
            ...
            logger.error(f"Failed to get team member by telegram_id {telegram_id} for team {team_id}: {e}")
            return None

    async def get_team_member_by_phone(self, phone_number: str, team_id: str) -> Optional[TeamMember]:
        ...
        try:
            ...
            logger.error(f"Failed to get team member by phone {phone_number} for team {team_id}: {e}")
            return None
    ...
    async def update_team_member(self, team_member: TeamMember) -> TeamMember:
        ...
        try:
            ...
            logger.info(f"Successfully updated team member {document_id} in team {team_member.team_id}")
            return team_member
    ...
    async def activate_team_member(self, telegram_id: int, team_id: str) -> Optional[TeamMember]:
    ...
    async def search_team_members(self, team_id: str, search_term: str) -> List[TeamMember]:
        ...
        try:
            ...
            for member in all_members:
                if (
                    (member.name and search_lower in member.name.lower()) or
                    (member.phone_number and search_lower in member.phone_number.lower()) or
                    (getattr(member, 'email', None) and search_lower in member.email.lower())
                ):
    ...
    async def update_team_member_field(self, telegram_id: int, team_id: str, field: str, value: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to update team member field {field} for telegram_id {telegram_id}: {e}")
            return False

    async def update_team_member_multiple_fields(self, telegram_id: int, team_id: str, updates: dict[str, str]) -> bool:
