...
class LLMIntentRecognizer:
    ...
    async def extract_intent(self, message: str, context: dict[str, Any] = None) -> IntentResult:
        ...
        try:
            ...
            crew = Crew(agents=[self.agent], tasks=[task], verbose=False, process="sequential")
            ...
            return IntentResult(
                ...
                confidence=0.0,
                entities={},
                reasoning=f"Error during intent extraction: {e!s}",
    ...
    def _fallback_parse(self, result: str, original_message: str) -> IntentResult:
        ...
        try:
            ...
            return IntentResult(
                ...
                confidence=0.0,
                entities={},
                reasoning=f"Complete parsing failure: {e!s}",
                original_message=original_message,
            )
