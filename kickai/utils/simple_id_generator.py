...
class SimpleIDGenerator:
    ...
    def generate_player_id(self, name: str, team_id: str, existing_ids: Optional[Set[str]] = None) -> str:
        """
    ...
    def generate_team_member_id(self, name: str, team_id: str, existing_ids: Optional[Set[str]] = None) -> str:
        """
        Generate a simple team member ID in format {Number}{Initials}.
        ...
        Returns:
            Team member ID in format 01MH, 02MH, etc.
        """
        # Use the same logic as player IDs
        return self.generate_player_id(name, team_id, existing_ids)
...
def generate_simple_team_member_id(name: str, team_id: str, existing_ids: Optional[Set[str]] = None) -> str:
