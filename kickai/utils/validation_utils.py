...
VALID_POSITIONS = {
    ...
    'defender', 'def', 'cb', 'rb', 'lb', 'centre-back', 'right-back', 'left-back',
    'midfielder', 'mid', 'cm', 'dm', 'am', 'centre-mid', 'defensive-mid', 'attacking-mid',
    'forward', 'fwd', 'st', 'cf', 'lw', 'rw', 'striker', 'centre-forward', 'left-wing', 'right-wing',
    'winger', 'wing'
}
...
def validate_team_member_input(name: str, phone: str, role: str, team_id: str) -> List[str]:
    ...
    # Validate role
    valid_roles = {
        'club administrator', 'admin', 'administrator',
