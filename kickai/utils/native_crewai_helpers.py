...
def convert_telegram_id(telegram_id: str) -> int | None:
    """
...
def validate_required_strings(*args: str, names: list[str]) -> str | None:
    """
...
def create_context_string(
    telegram_id: str, team_id: str, username: str, chat_type: str, additional_context: str = ""
) -> str:
    """
