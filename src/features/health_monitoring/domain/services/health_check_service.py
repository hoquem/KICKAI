...
from features.communication.domain.interfaces.daily_status_service_interface import (
    IDailyStatusService,
)
...
from features.health_monitoring.domain.interfaces.health_check_service_interface import (
    IHealthCheckService,
)
from features.payment_management.domain.interfaces.payment_operations import IPaymentOperations
from features.player_registration.domain.interfaces.fa_registration_checker_interface import (
        ...
        try:
            if not self.player_operations:
                return {
                    ...
                    "details": {"service": "player_operations"}
                }
