...
class TeamService(ITeamService):
    ...
    async def check_expense_against_budget(self, team_id: str, category: ExpenseCategory, amount: float) -> Tuple[bool, Optional[float]]:
        ...
        try:
            ...
            # Note: This method would need expense_service injected to get total expenses
            # For now, we'll return True to avoid breaking existing functionality
            # TODO: Refactor to inject expense_service dependency
            return True, limit
        except Exception as e:
