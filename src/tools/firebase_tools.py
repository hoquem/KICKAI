...
def get_firebase_client():
    ...
    Prioritizes firebase_settings.json file, falls back to environment variables.
    Returns:
        firebase_admin.firestore.Client: Firebase Firestore client instance
    Raises:
        ValueError: If neither file nor environment variables are available
    ...
    try:
        ...
        try:
            ...
            # First, try to use firebase_settings.json file
            # Look for the file in the same directory as .env (project root)
            # Get the current working directory (project root when running from project root)
            ...
            if os.path.exists(service_account_path):
                ...
                # Fall back to environment variables for Railway deployment
