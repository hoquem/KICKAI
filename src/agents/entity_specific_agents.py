...
from .configurable_agent import ConfigurableAgent, AgentContext
...
class EntitySpecificAgentManager:
    ...
    def get_appropriate_agent_for_entity(self, entity_type: EntityType, operation: str) -> Optional[AgentRole]:
