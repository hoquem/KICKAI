...
def find_best_agent_for_capability(capability: RefinedCapabilityType) -> Optional[AgentRole]:
    """Find the best agent for a specific capability."""
    return _hierarchical_capability_manager.find_best_agent_for_capability(capability)

def get_capability_definition(capability: RefinedCapabilityType) -> Optional[CapabilityDefinition]:
    """Get the definition for a specific capability."""
