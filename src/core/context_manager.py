...
class ContextManager:
    ...
    async def create_user_context(self, user_id: str, team_id: Optional[str] = None,
                                chat_id: Optional[str] = None, username: Optional[str] = None,
                                message_text: Optional[str] = None) -> UserContext:
