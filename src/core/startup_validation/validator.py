...
async def run_startup_validation(team_id: str | None = None) -> ValidationReport:
    ...
    # If no team_id provided, we'll need to get it from Firestore
    # For now, we'll use a placeholder that indicates it should be fetched
    if team_id is None:
        context = {"team_id": "TO_BE_FETCHED_FROM_FIRESTORE"}
    else:
