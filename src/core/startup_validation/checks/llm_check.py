        ...
        try:
            ...
            try:
                ...
                if isinstance(llm, str):
                    ...
                    try:
                        ...
                        return CheckResult(
                            ...
                            category=self.category,
                            status=CheckStatus.FAILED,
                            message=f"CRITICAL: LLM authentication failed - API key invalid or service unavailable: {str(auth_error)}",
                            error=auth_error,
                            details={
                                'provider': provider_str,
                                'model': llm,
                ...
                if hasattr(llm, 'invoke'):
                    ...
                    try:
                        ...
                        return CheckResult(
                            ...
                            category=self.category,
                            status=CheckStatus.FAILED,
                            message=f"CRITICAL: LLM authentication failed: {str(e)}",
                            error=e,
                            details={
                                'provider': provider_str,
                                'model': model_name,
                ...
                return CheckResult(
                    ...
                    category=self.category,
                    status=CheckStatus.FAILED,
                    message=f"CRITICAL: LLM initialization failed: {str(e)}",
                    error=e,
