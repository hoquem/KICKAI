...
from src.database.mock_data_store import MockDataStore
from src.features.registry import ServiceFactory, create_service_factory
...
class DependencyContainer:
    ...
    def _initialize_mock_data(self):
        ...
        try:
            ...
            from src.core.logging_config import logger
            from src.features.team_administration.domain.entities.team import Team, TeamStatus
